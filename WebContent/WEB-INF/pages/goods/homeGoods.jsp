                ...
                <form class="ng-pristine ng-invalid ng-invalid-required" action="<%=basePath%>goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="搜点什么吧..." style="height: 40px;"
                      	...
                      	<input type="submit" class="btn"value="搜索" style="margin-top:-8px;"></input>
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到【西安航空学院】校园二手市场。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>西安航空学院校园二手市场</p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入西安航空学院校园二手市场，你的大学，应更精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
