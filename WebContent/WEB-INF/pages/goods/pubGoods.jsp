                            ...
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-1">
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            <input type="file" name="myfile" data-ref="imgUrl" class="col-sm-10 myfile" multiple value=""/>
...
$(document).ready(function(){
 ...
 a.each(function(index, element) {
        $(this).blur(function(){
   //console.log("dadwr");
   if($(this).val()=="" && $(this).next().html()!= "不能为空"){
   ...
   if($(this).val()!="" && $(this).next().html()== "不能为空"){
    ...
    $(".myfile").on("fileuploaded", function (event, data, previewId, index) {
        ...
        var oldurl = $("#urlhidden").val();
        
        if(oldurl!=""){
        $("#urlhidden").val(oldurl+";"+data.response.imgUrl);
        }else{
        $("#urlhidden").val(data.response.imgUrl);
        }
